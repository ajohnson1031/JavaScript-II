...
let allCaps = [];
allCaps.push(runners.map(elem => elem.first_name.toUpperCase()));
...
const donations = runners.reduce((total, runner) => {
...
// Problem 1 - create a list of email addresses, first and last names for marketing purposes
const emailList = runners.map(elem => {
  return `Name: ${elem.last_name}, ${elem.first_name} - Email: ${elem.email}`;
});

//console.log(emailList);

// Problem 2 - Categorize donations into tiers 0 - 25, 26 - 50, 51 - 100. 100+

runners.forEach(elem => {
  if (elem.donation <= 25) elem.tier = "bronze";
  else if (elem.donation > 25 && elem.donation <= 50) elem.tier = "silver";
  else if (elem.donation > 50 && elem.donation <= 100) elem.tier = "gold";
  else elem.tier = "platinum";
});

function getTier(tier) {
  const thisTier = tier.toLowerCase();
  console.log(`---- Runners in ${thisTier} tier ----` + "\n");
  return runners.filter(elem => elem.tier === thisTier);
}

// console.log(getTier("bronze"));
// console.log(getTier("silver"));
// console.log(getTier("gold"));
// console.log(getTier("platinum"));

// Problem 3 - Get total count for all shirt sizes
//Sizes are XS, S, M, L, XL, 2XL, 3XL

const sizeCount = function(size) {
  const s = size.toUpperCase();
  console.log(`Shirts needed in size ${s}`);
  return runners.filter(elem => elem.shirt_size === s).length;
};
// console.log(sizeCount("S"));
// console.log(sizeCount("m"));
// console.log(sizeCount("l"));
// console.log(sizeCount("XL"));
// console.log(sizeCount("2xl"));
// console.log(sizeCount("3XL"));
